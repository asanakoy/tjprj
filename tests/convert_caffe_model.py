...
MODELS_DIR = '/export/home/asanakoy/workspace/wikiart/cnn/style_150/rs_balance/model'
DATA_DIR = os.path.join(os.path.dirname(__file__), 'data')
DATA_PATH = os.path.join(MODELS_DIR, 'snap_iter_290408.npy')
SNAPSHOT_PREFIX_PATH = '/export/home/asanakoy/workspace/wikiart/cnn/style_150/rs_balance/model/snap_iter_290408.tf'
NUM_CLASSES = 84
