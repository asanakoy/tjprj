...
def run_training(**params):
    with tf.Graph().as_default():
        ...
        # TODO: Run clustering and return indices
        # params_generator, params_sampler = get_params_clustering()
        # sim_matrix, flip_matrix = compute_simMatrix(sgd_iter=0)
        # batch_ldr_dict_params = runClustering(kwargs_generator, kwargs_sampler)
