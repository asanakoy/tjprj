...
def get_pathes(is_bbox_sq):
    ...
    output_dir = os.path.expanduser('/export/home/asanakoy/workspace/OlympicSports/cnn/convnet_joint_categories_imagenet')
...
def main(argv):
    ...
    params = {
        ...
        'snapshot_path_to_restore': None, #'/export/home/asanakoy/workspace/OlympicSports/cnn/convnet_joint_categories_imagenet_convlr0.1/round_checkpoint-1',
