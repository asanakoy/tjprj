...
def get_pathes(is_bbox_sq):
    ...
    output_dir = os.path.expanduser('/export/home/asanakoy/workspace/OlympicSports/cnn/convnet_joint_categories_scratch')
...
def main(argv):
    ...
    params = {
        ...
        'test_layers': ['maxpool5', 'fc6'],
        'snapshot_path_to_restore': '/export/home/asanakoy/workspace/OlympicSports/cnn/convnet_joint_categories_scratch/checkpoint-100000',
        'init_model': get_first_model_path(),
        'num_layers_to_init': 0,
        'network': tfext.convnet.Convnet,
